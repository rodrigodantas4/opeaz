...
from .authentication import EntitySessionAuthentication

from .context import clear_session_entity, get_accessible_node_or_404, set_session_entity
...
class EntityTreeView(EntityContextMixin, APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            _, items = TreeService.build_aggregated_view(
